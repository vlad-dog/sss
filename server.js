  ...
  const Jimp = require("jimp")
    ...
    if (!canal) return;
        ...
        if (canal.type === "text") {            
            ...
            .setThumbnail('https://imgur.com/gallery/yEsNG')
            .setColor("Random")
            .setTitle("Bye Bye")
            .addField(`Bye ${username}`, "I will miss you")
            .setFooter("we will miss you..")
            canal.send(embed);
        }
    })
...
client.on("guildMemberAdd", async member => {
  ...
  const Jimp = require("jimp")
    ...
    if (!canal) return;
        ...
        if (canal.type === "text") {            
            const embed = new Discord.RichEmbed()
            .setThumbnail('https://imgur.com/gallery/MHVdszB')
            .setColor("RANDOM")
            .setTitle("Welcome")
            .addField(`Hello ${username} i think you will have fun in this server`, "For any questions , dm admins . Have FUN!")
            .setFooter("CONFIRMED")
            canal.send(embed);
...
client.login('Njk4NTk5Mzc2ODAwNzEwNjU2')
...
client.login('Njk4NTk5Mzc2ODAwNz')